...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("bluedolphin.hsluv")
    if color ~= "NONE" then
...
---@param groups bluedolphin.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/bluedolphin-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, bluedolphin.Cache
