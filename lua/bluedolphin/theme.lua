...
function M.setup()
  ...
  theme.highlights = {
    ...
    Function = { fg = c.blue10, style = options.styles.functions }, -- function name (also: methods for classes)
    ...
    ["@namespace.builtin"] = { fg = c.red2 }, -- Variable names that are defined by the languages, like `this` or `self`.
    ...
    -- BufferInactive = { bg = c.bg_dim, fg = util.darken(c.dark5, 0.8) },
