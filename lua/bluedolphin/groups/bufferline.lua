...
function M.get(c, opts)
  ...
  return {
    ...
    BufferLineOffsetSeparator = { bg = opts.styles.bufferline == "transparent" and c.none or c.bg_dim, fg = c.cyan },
    -- BufferLineSeparator = { bg = c.bg_bufferline, fg = c.fg_gutter},
    -- BufferLineSeparatorVisible = { bg = c.bg_bufferline, fg = c.comment },
