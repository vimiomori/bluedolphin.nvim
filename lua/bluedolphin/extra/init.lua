...
function M.setup()
  M.docs()
  local bluedolphin = require("bluedolphin")
  ...
  for extra, info in pairs(M.extras) do
    package.loaded["bluedolphin.extra." .. extra] = nil
    local plugin = require("bluedolphin.extra." .. extra)
    for style, style_name in pairs(styles) do
      bluedolphin.setup({ style = style })
      bluedolphin.load({ style = style })
      vim.cmd.colorscheme('bluedolphin-' .. style)
      local colors = require("bluedolphin.colors").setup({ transform = true })
      local fname = extra .. "/bluedolphin_" .. style .. "." .. info.ext
      colors["_upstream_url"] = "https://github.com/folke/bluedolphin.nvim/raw/main/extras/" .. fname
